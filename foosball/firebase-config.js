// Firebase Configuration for FELIZZO '25 Foosball
...
const tournamentRef = firebase.database().ref('felizzo2025/foosball/tournamentData');
const knockoutRef = firebase.database().ref('felizzo2025/foosball/knockoutData');

console.log('Firebase initialized for Foosball');
console.log('Tournament path: felizzo2025/foosball/tournamentData');
